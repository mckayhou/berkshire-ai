...
> Last Updated: 2026-07-27 | Loop Engine: Active (L2 - Assisted) | **Version: V10.29**（package 10.29.3：全链路 576 passed（2026-08-11）；upstream P0/P1 + Dojo bridge）
...
| 2026-08-11 | **全链路验收** | e2e **9/9** + pytest **576 passed**（MiniMax-M3）；文档同步 | TESTING / VERSION_HISTORY |
...
| 2026-07-27 | **全链路验收** | pytest **576 passed**（含 LLM e2e）；手工 weekly-posterior/feedback/twstock/dojo-bridge | TESTING.md / VERSION_HISTORY |
...
| 2026-07-24 | **Dojo holdings bridge** | Dojo portfolio→holdings.json；DecisionRecord 组合权重/风险旗标 | `dojo_holdings_bridge` / `decision_log` |
| 2026-07-24 | **upstream P0 cherry-pick** | 移植 income-investment / thesis-drift / twstock_data；financial-data 台股节 | `skills/*` `tools/twstock_data.py` |
