...
## Summary
- 135 nodes · 106 edges · 125 communities (35 shown, 90 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7fb9e56d`
...
6. `Berkshire AI V10.0 - TextGrad 化设计` - 3 edges
...
## Communities (125 total, 90 thin omitted)
...
- **Why does `Berkshire AI — Four-Masters Parallel Investment Research (Upstream fully integrated)` connect `Community 4` to `Community 123`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `报告输出规范（report conventions）` connect `Community 123` to `Community 4`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
