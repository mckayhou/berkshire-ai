...
def test_pipeline_factor_scan_wires_proposer():
    factor_scan = {
        "ok": True,
        "candidates": [{"ticker": "600519", "score": 0.3, "direction": "long", "note": "x"}],
    }
    d = DecisionRecord(
        ticker="600519",
        date="2026-01-02",
    ...
    assert any(h.ticker == "600519" for h in rd.all_hypotheses)
